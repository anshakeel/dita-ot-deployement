...
set CLASSPATH=%DITA_DIR%lib\jackson-annotations-2.13.2.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-core-2.13.2.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-databind-2.13.2.2.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-dataformat-yaml-2.13.2.jar;%CLASSPATH%
